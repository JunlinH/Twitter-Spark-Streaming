...
if __name__ == "__main__":
    ...
    consumer_key = "FILLING UP YOUR CONSUMER KEY HERE"
    consumer_secret = "FILLING UP YOUR CONSUMER KEY SECRET HERE"
    access_token = "FILLING UP YOUR ACCESS TOKEN HERE"
    access_token_secret = "FILLING UP YOUR ACCESS TOKEN SECRET HERE"
